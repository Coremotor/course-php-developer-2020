<form id="form-gallery" method="post" class="img-container">
    ...
    <?php foreach ($arrFilter as $file): ?>
        <div class="img-item">
            ...
            <input id="<?= $file ?>" class="img-cb uk-checkbox" type="checkbox" name="deleteListCheckbox[]" value="<?= $file ?>">

        </div>
    <?php endforeach; ?>

    <button class="btn uk-button uk-button-default" type="submit" name="formDel" value="Удалить выбранные">Удалить выбранные</button>
